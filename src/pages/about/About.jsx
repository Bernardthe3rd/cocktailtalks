    ...
    return (
        <>
            <main className="container">
                <div className="about--container__outer">
                    <div className="about--div__box">
                        <h3>Our story - How CocktailTalk started</h3>
                        <article className="about--article__box">
                            ...
                            <Link to="/login" className="button-link-main">join us</Link>
                        </article>
                    </div>
